...
$query="update citizen set image='$imageName' where email='".$_SESSION['user']."'";
...
else
{
	...
	$err="<font color='blue'>Picture already in exist</font>";
...
echo '<h2 align="center">Update Your Image Just once</h2>
